...
// Produces a single self-contained browser global (window.OpticalMargin) with no module loader,
...
export default defineConfig({
	build: {
		...
		lib: {
			...
			formats: ['iife'],
			// Exposes the module's exports (init, refit, destroy) as window.OpticalMargin.
			name: 'OpticalMargin',
			fileName: () => 'opticalmargin.webflow.min.js',
		},
		minify: true,
	},
})
